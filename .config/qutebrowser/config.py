...
config.bind('<Mod4-+>', 'tab-focus 1')
config.bind('<Mod4-ě>', 'tab-focus 2')
config.bind('<Mod4-š>', 'tab-focus 3')
config.bind('<Mod4-č>', 'tab-focus 4')
config.bind('<Mod4-ř>', 'tab-focus 5')
config.bind('<Mod4-ž>', 'tab-focus 6')
config.bind('<Mod4-á>', 'tab-focus 7')
config.bind('<Mod4-í>', 'tab-focus 8')
config.bind('<Mod4-é>', 'tab-focus -1')
config.bind('<Mod4-Tab>', 'tab-focus last')
